...
# Actual set containing datapoints
class Subcluster:
...
class CFNode:
    def __init__(self, is_leafnode, max_num_entries_leafnode_L, branching_factor_B):
        ...
        self.CF = CF()
        self.CF_list = [] # made of elements in the form [CF, Subcluster] (for leafnode) or [CF, CFNode] (for non-leafnode)
        self.parent = None
...
class CFTree:
    ...
    def insert(self, datapoint): # datapoint is a numpy.ndarray
        ...
        # At this point current_node is the leafnode CFNode where, somewhere, we want to insert the datapoint

        # Find the Subcluster among those in the selected leafnode current_node
        ...
        insertion_successful = current_node.CF_list[current_subcluster_choice][1].add_datapoint(datapoint) # here current_node is a leafnode
        ...
        if insertion_successful or len(current_node.CF_list) < self.max_num_entries_leafnode_L:
            ...
            # Insertion failed but there is enough space in the leafnode
            ...
            # Split the old leafnode into two new leafnodes
    ...
    def split_node(self, node, are_leaves):
        ...
        for object_i in range(len(node.CF_list)): # depending on the value of are_leaves, the object is either a subcluster or a node
    ...
    def get_a_leafnode(self):
        ...
        while current_node.is_leafnode is False:
            current_node = current_node.CF_list[0][1]
        return current_node
